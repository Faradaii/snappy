...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(4278282109),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4289981439),
      ...
      tertiaryFixedDim: Color(4287025642),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(4287025642),
      onTertiary: Color(4278203970),
      tertiaryContainer: Color(4278210143),
      onTertiaryContainer: Color(4289981439),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(4287354350),
      onTertiary: Color(4278196513),
      tertiaryContainer: Color(4283341746),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(4287354350),
      onTertiaryContainer: Color(4278190080),
      ...
      tertiaryFixedDim: Color(4287354350),
